...
def tune_threshold(config, model, hp):
    ...
    # Computing TPs and TNs
    tn, fp, fn, tp = sklearn.metrics.confusion_matrix(labels, predicts).ravel()
...
if __name__ == "__main__":
    ...
    #GIAparser.add_argument("--input_path", type=str, default='input/candidates_small.jsonl')
    #GIAparser.add_argument("--output_path", type=str, default='output/matched_small.jsonl')
